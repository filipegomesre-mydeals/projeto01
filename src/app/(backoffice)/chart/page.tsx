    ...
    return (
        <div className="relative space-y-4">
            ...
            <div className="min-h-[calc(100vh-160px)] w-full space-y-4">
                <div className="flex flex-col md:grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
                    <OnlineSalesAreaChart isCardHeader={false} />
                    <LineSingleChart />
                    <LineChart />
                    <DistributionRadialStackedChart isShowHeader={false} />
                    <RadarAreaChart
                        cardContentClassName="max-h-[400px] h-full w-full"
                        cardclassName="shadow-sm dark:bg-black-dark"
                    />
                    <DailySalesBarChart />
                </div>
