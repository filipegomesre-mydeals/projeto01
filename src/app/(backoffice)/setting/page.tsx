        ...
        <div className="space-y-4">
            ...
            <div className="min-h-[calc(100vh-160px)] w-full rounded-lg">
                <Tabs defaultValue="my-profile">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <Card>
                                <CardHeader className="space-y-1.5 rounded-t-lg border-b border-gray-300 bg-gray-100 px-5 py-4 text-base/5 font-semibold text-black dark:border-gray-700/50 dark:bg-black/30 dark:text-white">
                                    <h3>Personal info</h3>
                                    <p className="text-sm/tight font-medium text-gray-700 dark:text-gray-600">
                                    ...
                                    <form className="space-y-5 p-4">
                                        <div className="flex flex-wrap items-center gap-2.5">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-xs/tight text-gray dark:text-gray-600">
                                        ...
                                        <div className="space-y-2.5">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    className="ltr:pl-9 ltr:pr-20 rtl:pl-20 rtl:pr-9"
                                                />
                                                <Mail className="absolute top-3 size-4 ltr:left-3 rtl:right-3" />
                                                <button
                                                    type="button"
                                                    className="absolute top-0 rounded-lg bg-white p-2 font-semibold text-primary dark:text-white transition hover:text-black ltr:right-1 rtl:left-1 dark:bg-transparent dark:hover:text-primary"
                                                >
                                                    Change
                                                </button>
                                            </div>
                                        ...
                                        <div className="space-y-2.5">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    className="ltr:pl-9 ltr:pr-20 ltr:text-left rtl:pl-20 rtl:pr-9 rtl:text-right"
                                                />
                                                <Phone className="absolute top-3 size-4 ltr:left-3 rtl:right-3" />
                                                <button
                                                    type="button"
                                                    className="absolute top-0 rounded-lg bg-white p-2 font-semibold text-primary dark:text-white transition hover:text-black ltr:right-1 rtl:left-1 dark:bg-transparent dark:hover:text-primary"
                                                >
                    ...
                    <TabsContent
                        value="password"
                        className="mx-auto w-full max-w-[566px] font-medium text-black dark:text-white"
                    >
                        <Card>
                            <CardHeader className="space-y-1.5 rounded-t-lg border-b border-gray-300 bg-gray-100 px-5 py-4 text-base/5 font-semibold text-black dark:border-gray-700/50 dark:bg-black/30 dark:text-white">
