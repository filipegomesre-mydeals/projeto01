...
function CalendarDayButton({
    ...
    return (
        <Button
            ...
            className={cn(
                'group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 dark:hover:text-accent-foreground dark:hover:bg-black-dark flex aspect-square size-6.5 w-full flex-col gap-1 bg-transparent p-0 text-xs leading-none font-medium text-black group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] hover:bg-gray-300/50 data-[range-end=true]:rounded-lg data-[range-end=true]:bg-black data-[range-end=true]:text-white data-[range-middle=true]:bg-black data-[range-middle=true]:text-white data-[range-start=true]:rounded-lg data-[range-start=true]:rounded-l-lg data-[range-start=true]:bg-black data-[range-start=true]:text-white data-[selected-single=true]:bg-black data-[selected-single=true]:text-white dark:text-white dark:data-[range-end=true]:bg-white dark:data-[range-end=true]:text-black dark:data-[range-middle=true]:bg-white dark:data-[range-middle=true]:text-black dark:data-[range-start=true]:bg-white dark:data-[range-start=true]:text-black dark:data-[selected-single=true]:bg-white dark:data-[selected-single=true]:text-black [&>span]:text-xs [&>span]:opacity-70',
                defaultClassNames.day,
                className,
            )}
            {...props}
