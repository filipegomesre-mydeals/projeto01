                ...
                <Card className="m-auto w-full max-w-[400px] space-y-[30px] p-5 shadow-sm md:w-[400px]">
                    ...
                    <CardContent>
                        <form className="space-y-[30px]">
                            ...
                            <Link
                                href="/login"
                                className="flex items-center justify-center gap-2 pl-1.5 text-sm/tight font-semibold text-black hover:text-[#3C3C3D] dark:text-white dark:hover:text-primary"
                            >
