    ...
    return (
        <div className="sticky top-0 z-50 bg-white sm:bg-transparent shadow-sm sm:shadow-none">
            <div className="container">
                <div className="flex items-center justify-between gap-5 bg-white py-5 rounded-none sm:shadow-sm sm:rounded-b-[20px] sm:p-5 lg:p-[30px]">
                    ...
                    >
                        ...
                        <Link href="/">
                            <Button
                                variant={'black'}
                                type="button"
                                className="w-full bg-black! text-white! hover:bg-[#3C3C3D]!"
                                size={'extralarge'}
                            >
                                <ShoppingBag />
                                Purchase Now
                        ...
                        >
                            <Button
                                variant={'black'}
                                type="button"
                                className="w-full bg-success! text-white! hover:!bg-opacity-80"
                                size={'extralarge'}
                            >
                                <Phone />
                                Contact US
