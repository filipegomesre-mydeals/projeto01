...
const CrossHatchBar: ActiveShape<BarProps, SVGPathElement> | undefined = (
    props: BarProps,
) => {
    ...
    return (
        <>
            ...
            <rect
                ...
                rx={8}
                ry={8}
                className="dark:fill-gray-500 dark:opacity-80"
            />
        </>
    )
}
...
export function DailySalesBarChart({
    ...
    return (
        <Card className="relative flex flex-col justify-between space-y-5 p-5 shadow-sm">
            {!isShowTitle && (
                <span className="mb-0! text-base/5 font-semibold text-black dark:text-white">
                    Column Stacked
                </span>
            )}
            {isShowTitle && (
                <div className="flex items-start justify-between">
                    <div className="space-y-2.5">
                        <p className="text-[10px]/none uppercase dark:text-gray-500">
                            average daily sales
                        </p>
