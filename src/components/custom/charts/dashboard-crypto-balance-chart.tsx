...
const CylinderBar = (props: CylinderBarProps) => {
    const { fill = '#000', x: xValue = 0, y = 0, width = 0, height = 0 } = props
...
const BackgroundBar: ActiveShape<BarProps, SVGPathElement> | undefined = (
    props: BarProps,
) => {
...
const DashboardCryptoBalanceChart = () => {
    ...
    return (
        <ChartContainer
            config={chartConfig}
            className="relative mb-5 w-full sm:h-full sm:max-h-72"
        >
