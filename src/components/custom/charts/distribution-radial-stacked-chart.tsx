...
export function DistributionRadialStackedChart({
    ...
    return (
        <Card
            className={cn(
                'relative min-w-80 p-5 shadow-sm xl:min-w-0',
                className,
            )}
        >
            {isShowTitle && (
                ...
                <div className="flex items-start justify-between">
                    ...
                    <Popover>
                        ...
                        <PopoverContent className="w-full space-y-1.5 p-1.5">
                            <button
                                type="button"
                                className="block w-full whitespace-nowrap rounded-lg px-2.5 py-1.5 text-left text-xs/tight font-medium text-black hover:bg-light-theme ltr:text-left rtl:text-right dark:text-gray-500 dark:hover:bg-gray-200/10 dark:hover:text-white"
                            >
                                Yearly
                            </button>
                            <button
            ...
            <CardContent>
                ...
                <div className="relative z-10 -mt-10 flex flex-wrap place-items-center justify-center gap-x-8 gap-y-5 p-4 font-semibold sm:grid-cols-3 xl:grid xl:gap-5">
                    <div className="relative pl-2.5 pr-1.5">
                        ...
                        <h4 className="whitespace-nowrap text-xs/tight">
                            Website
                        </h4>
