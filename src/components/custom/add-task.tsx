...
export default function AddTask({
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                <Plus className="size-[18px] text-black hover:text-gray dark:text-white dark:hover:text-gray-500" />
            </DialogTrigger>
                ...
                <Card className="shadow-none!">
                    <CardHeader>
                        <div className="space-y-1.5 text-base/5 font-semibold text-black dark:text-white">
                            <h2>Add Task</h2>
                            <p className="text-xs/snug font-medium text-gray-700 dark:text-gray-600">
