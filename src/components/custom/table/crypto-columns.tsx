    ...
    },
    {
        ...
        header: ({ column }) => {
            return (
                ...
                >
                    Price
                    <span className="inline-flex flex-col items-center -space-y-px">
                        <IconShoringArrowup
                            className={`size-2 shrink-0 text-black dark:text-gray-500 ${column.getIsSorted() === 'asc' && 'text-gray-500 dark:text-white'}`}
                        />
                        <IconShoringArrowup
                            className={`size-2 shrink-0 rotate-180 text-gray-500 dark:text-white ${column.getIsSorted() === 'asc' && 'text-black! dark:text-gray-500!'}`}
                        />
                    </span>
                </button>
            )
